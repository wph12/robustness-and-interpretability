...
if __name__ == "__main__":
    ...
    if parsed_args.test_interpretable: 
        ...
        if(args['dataset'] == 'imagenet'):
            ...
            interpretability_metrics(model_conv, imagenet_proxy, dataloaders['mini'], run_id, xai_method ='occlusion',
            ...
            interpretability_metrics(model_conv, cifar_proxy, dataloaders['mini'], run_id, xai_method ='occlusion',
                                    use_ground_truth= True,
                                    use_alignment= False,
                                    use_infidelity=False, 
                                    use_max_sensitivity=True, 
